...
def reset():
    global api_areas
    api_areas = [
        {"name": "Hospital", "priority": 4, "usage": 100},
        {"name": "CityCenter", "priority": 3, "usage": 150},
        {"name": "Residential", "priority": 1, "usage": 120}
    ]
    return {"state": api_areas}
